...
grouped_summary_table <- function(data, ..., prop = FALSE, output_format = NULL) {
    if (is.null(output_format)) {
    output_format <- if (is_latex_output()) "pdf" else "html"
  }
  ...
  if (output_format == "html") {
    ...
    stop("Invalid output format. Choose either 'html' or 'pdf'.")
  }
}
```
